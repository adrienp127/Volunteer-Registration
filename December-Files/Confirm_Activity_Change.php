...
$qry2="SELECT * FROM project WHERE id=$activity_name";
// Attempt insert query execution
$sql = "UPDATE activity SET time_from='$time_from', time_to='$time_to', date='$date', project_id='$project_id', role_id='$role_id', activity_name='$activity_name' Where id='$id'";
