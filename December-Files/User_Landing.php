                            ...
                            echo '<table class="table table-bordered table-striped">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
					    echo '<a href="take_shift.php?id='. $row['id'] .'" class="mr-3" title="Take Shift" data-toggle="tooltip"><span class="fa fa-check-square-o"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    // Attempt select query execution
                    $sql = "SELECT * FROM timesheet WHERE employee_id=50";
