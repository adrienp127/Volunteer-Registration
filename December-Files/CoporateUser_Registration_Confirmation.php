...
<body>
	...
	<div class="login-signup">
		<a href="Coporate_Landing.php">Login</a>
	</div>
...
$sql = "INSERT INTO account (username, password, email, first_name, last_name, role_id) VALUES ('$username', '$password', '$email', '$firstname', 'lastname', 3)";
